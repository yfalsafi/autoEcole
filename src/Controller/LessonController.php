...
//
//        if ($start != $end)
//            $errors[] = 'The Beginning and the end must be at the same day';
...
//        $start = $lesson->getStartAt()->format('i');
//        $end = $lesson->getEndAt()->format('i');
//        if ($end != $start || $start != 0 && $start != 30)
//            $errors[] = "You can only reserve 1 or 2 hours ";
//        return $errors;
    }
